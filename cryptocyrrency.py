...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  7 11:44:48 2022
...
def mine_block():
    ...
    response = {'message': 'You have mined a new block! Congrats!', 
                'index': block['index'], 
...
def get_chain():
    ...
    response = {'chain': chain, 'length_of_chain':len(chain)}
    return jsonify(response), 200
